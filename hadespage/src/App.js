    ...
    return (
        <div className="flex min-h-screen">
            ...
            <main className="ml-20 p-8 w-full bg-zinc-700"> 
                ...
                <section id="trabajos" className="border-4 border-zinc-500 p-8 bg-zinc-200 rounded-xl shadow-lg">
            ...
            <section id="sobre-mi" className="p-8 bg-zinc-200 rounded-xl shadow-lg mt-12 border-4 border-zinc-500">
